...
export const STRINGS = {
  ...
  "dash.todo_finished_projects": { es: "Proyectos terminados", en: "Completed projects" },
  "dash.finished_hint": { es: "Haz click para verlos", en: "Click to view them" },
  ...
  "fex.score_label": { es: "Nota (1 a 4)", en: "Score (1 to 4)" },
  "fex.justification_label": { es: "Justifica tu valoración", en: "Justify your score" },
  "fex.err_score": { es: "Selecciona una nota del 1 al 4.", en: "Select a score from 1 to 4." },
