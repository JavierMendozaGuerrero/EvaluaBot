...
export const STRINGS = {
  ...
  "err.ia_cola_llena": { es: "Ahora mismo se están analizando varias evaluaciones a la vez y no ha llegado tu turno. No es un fallo tuyo: espera unos minutos y vuelve a intentarlo. Lo que ya tengas confirmado sigue guardado.", en: "Several evaluations are being analysed at once right now and your turn hasn't come up. This isn't your fault: wait a few minutes and try again. Anything you already confirmed is still saved." },
  ...
  "admin.eval_compliance_note": { es: "Por mes y tipo: evaluaciones realizadas / asignadas a esta persona.", en: "By month and type: evaluations completed / assigned to this person." },
  "admin.eval_compliance_empty": { es: "Aún no hay evaluaciones asignadas registradas.", en: "No assigned evaluations recorded yet." },
  "admin.eval_year": { es: "Año", en: "Year" },
  "admin.eval_cat_slack": { es: "Slack (opcionales)", en: "Slack (optional)" },
  "admin.eval_cat_proyecto": { es: "Finalizar proyectos (obligatorias)", en: "Closing projects (mandatory)" },
  ...
  // --- Chat de seguimiento personal (ChatEvalPersonal). Los botones comunes
  //     (Comenzar, Sí/No, Modificar, Evaluación completada) reusan las claves cep.*
  "csp.intro": { es: "📝 *Seguimiento personal*\n\n_Esta evaluación es totalmente privada, solo podrá verla tu CA._\n_Si en algún momento quieres cancelar, cierra esta sección._\n\n*Pulsa el botón* para comenzar.", en: "📝 *Personal tracking*\n\n_This review is fully private; only your CA will be able to see it._\n_If at any point you want to cancel, just close this section._\n\n*Tap the button* to start." },
  "csp.chance_to": { es: "*Esta es tu oportunidad para:*\n\n*1.* Explicar cómo estás ayudando en _\"Contribution to the firm\"_\n*2.* Cómo te estás acercando a tus objetivos\n*3.* Señalar limitaciones o aspectos relevantes respecto al cumplimiento de los criterios de evaluación\n*4.* Si necesitas ayuda con algún tema o has tenido alguna dificultad que quieras comentar\n\nYa puedes escribir tu comentario.", en: "*This is your chance to:*\n\n*1.* Explain how you are helping with _\"Contribution to the firm\"_\n*2.* How you are getting closer to your goals\n*3.* Point out limitations or anything relevant to how you are meeting the evaluation criteria\n*4.* Whether you need help with something or have run into any difficulty you want to raise\n\nYou can write your comment now." },
  "csp.btn_goals": { es: "📋 Ver mis objetivos", en: "📋 View my goals" },
  "csp.my_goals": { es: "📌 *Tus objetivos actuales:*", en: "📌 *Your current goals:*" },
  "csp.no_goals": { es: "📌 No tienes objetivos registrados actualmente.", en: "📌 You have no goals recorded at the moment." },
  "csp.err_goals": { es: "⚠️ No se pudieron cargar los objetivos: {msg}", en: "⚠️ Could not load your goals: {msg}" },
  "csp.btn_criteria": { es: "📊 Ver criterios", en: "📊 View criteria" },
  "csp.ask_area": { es: "¿Para qué área quieres ver los criterios?", en: "Which area do you want to see the criteria for?" },
  "csp.no_criteria": { es: "📊 No hay criterios disponibles para este área.", en: "📊 There are no criteria available for this area." },
  "csp.criteria_head": { es: "📊 *Criterios — {area}*", en: "📊 *Criteria — {area}*" },
  "csp.err_criteria": { es: "⚠️ No se pudieron cargar los criterios: {msg}", en: "⚠️ Could not load the criteria: {msg}" },
  "csp.ph_comment": { es: "Escribe tu comentario...", en: "Type your comment..." },
  "csp.your_comment": { es: "📋 Tu comentario:\n_{val}_\n\n¿Lo guardo?", en: "📋 Your comment:\n_{val}_\n\nShall I save it?" },
  "csp.saved_more": { es: "✅ Evaluación guardada. ¿Quieres añadir otro comentario?", en: "✅ Review saved. Do you want to add another comment?" },
  "csp.err_save": { es: "⚠️ No se pudo guardar: {msg}", en: "⚠️ Could not save: {msg}" },
  "csp.rewrite": { es: "Escribe de nuevo tu comentario:", en: "Type your comment again:" },
  "csp.what_else": { es: "¿Qué más me quieres contar? Responde con tu comentario.", en: "What else would you like to tell me? Reply with your comment." },
  "csp.bye": { es: "Muchas gracias. Ya puedes cerrar esta sección 👋", en: "Thank you very much. You can now close this section 👋" },
  "csp.err_unknown": { es: "Error desconocido", en: "Unknown error" },
  ...
  "ad.view_current_report": { es: "Ver versión actual del informe", en: "View current report version" },
  "ad.current_open_again": { es: "Abrir de nuevo en ", en: "Open again in " },
  "ad.current_open_web": { es: "web", en: "web" },
  "ad.current_open_word": { es: "Word", en: "Word" },
  "ad.current_is_draft_pre": {
    es: "Lo que has abierto es el borrador en curso, aún no es la versión final. Puedes ",
    en: "What you opened is the draft in progress, not the final version yet. You can ",
  },
  "ad.current_is_draft_link": { es: "seguir editándolo", en: "keep editing it" },
  "ad.current_is_draft_post": { es: ".", en: "." },
  "ad.no_final_pre": { es: "Aún no has finalizado el informe final de {nombre}, ve ", en: "You haven't finished {nombre}'s final report yet, go " },
  "ad.no_final_link": { es: "aquí", en: "here" },
  "ad.no_final_post": { es: " para hacerlo.", en: " to do it." },
  ...
  "ad.give_access_needs_final": {
    es: "Para dar acceso, publica antes el informe final: un borrador no cuenta.",
    en: "To give access, publish the final report first: a draft doesn't count.",
  },
  ...
  "mpa.manager": { es: "Manager", en: "Manager" },
  "mpa.manager_hint": { es: "Eres el manager del proyecto: no puedes eliminarte.", en: "You're the project manager: you can't remove yourself." },
  ...
  "eaw.draft_step_desc_manual": { es: "Rellena el informe directamente aquí, como un Word. Todos los campos están vacíos; escribe las notas, comentarios, retribución, promoción, salarios y objetivos, y guárdalo en Notion. No hace falta descargar nada.", en: "Fill in the report directly here, like a Word document. All fields are empty; write the scores, comments, compensation, promotion, salaries and objectives, then save it to Notion. No download needed." },
  "eaw.draft_step_desc": { es: "Este informe replica la plantilla oficial de IGENERIS. Los comentarios vienen prellenados con lo acordado en cada área; los campos resaltados (notas, retribución, promoción, salarios, deadlines) están vacíos para que los rellenes tú. Edítalo aquí como un Word y guárdalo en Notion: no hace falta descargar nada.", en: "This report mirrors the official IGENERIS template. Comments are pre-filled with what was agreed for each area; the highlighted fields (scores, compensation, promotion, salaries, deadlines) are empty for you to fill in. Edit it here like a Word document and save it to Notion: no download needed." },
  "eaw.save_draft": { es: "Guardar borrador", en: "Save draft" },
  "eaw.draft_saved": { es: "Borrador guardado en Notion", en: "Draft saved to Notion" },
  "eaw.upload_final": { es: "Subir como versión final", en: "Upload as final version" },
  "eaw.upload_confirm": { es: "¿Guardar este informe en Notion? Se registrará en «Informes finales» (TO-SEE) como la versión oficial del informe de esta persona.", en: "Save this report to Notion? It will be registered in “Informes finales” (TO-SEE) as this person's official report version." },
  "eaw.uploading": { es: "Guardando…", en: "Saving…" },
  "eaw.uploaded_ok": { es: "Informe guardado en Notion ✓", en: "Report saved to Notion ✓" },
  "eaw.open_in_notion": { es: "Abrir en Notion", en: "Open in Notion" },
  "eaw.sources_bar": { es: "Fuentes de apoyo — se descargan y se abren a la derecha para consultarlas mientras rellenas:", en: "Supporting sources — downloaded and opened on the right to read while you fill in:" },
  "eaw.src_opinions": { es: "Opiniones", en: "Opinions" },
  "eaw.src_proj": { es: "Evals. proyecto", en: "Project evals" },
  "eaw.src_tracking": { es: "Seguimiento", en: "Tracking" },
  "eaw.src_monthly": { es: "Evals. mensuales", en: "Monthly evals" },
  "eaw.src_extra": { es: "Evals. extra", en: "Extra evals" },
  "eaw.src_all": { es: "Todo en un PDF", en: "All in one PDF" },
  "eaw.preview_close": { es: "Cerrar ✕", en: "Close ✕" },
  "eaw.score_legend": { es: "Notas: A = Achieves · E = Exceeds · EM = Expects more.", en: "Scores: A = Achieves · E = Exceeds · EM = Expects more." },
  "eaw.total_variable_short": { es: "Total Variable", en: "Total Variable" },
  "eaw.val_intro": { es: "No se puede guardar la versión final: completa/corrige estos campos (los objetivos son opcionales):", en: "Can't save the final version: complete/fix these fields (objectives are optional):" },
  "eaw.val_ca_next": { es: "CA del año siguiente (vacío).", en: "Next year's CA (empty)." },
  "eaw.val_salary": { es: "Salario actual: debe ser numérico.", en: "Current salary: must be numeric." },
  "eaw.val_area_score": { es: "Nota del área «{area}»: elige A, E o EM.", en: "Score for area “{area}”: choose A, E or EM." },
  "eaw.val_area_comment": { es: "Comentarios del área «{area}» (vacío).", en: "Comments for area “{area}” (empty)." },
  "eaw.val_score_projects": { es: "Nota final Proyectos: número entero del 1 al 5.", en: "Final Projects score: a whole number from 1 to 5." },
  "eaw.val_score_cttf": { es: "Nota final Contrib. to the firm: número entero del 1 al 5.", en: "Final Contribution to the firm score: a whole number from 1 to 5." },
  "eaw.val_pct": { es: "«{field}»: debe ser un porcentaje.", en: "“{field}”: must be a percentage." },
  "eaw.val_promotion": { es: "Promoción: elige SÍ o NO.", en: "Promotion: choose YES or NO." },
  "eaw.val_position": { es: "Posición del año siguiente (vacío).", en: "Next year's position (empty)." },
  "eaw.val_new_salary": { es: "Nuevo salario fijo: debe ser numérico.", en: "New fixed salary: must be numeric." },
