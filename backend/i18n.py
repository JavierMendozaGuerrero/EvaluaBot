...
TEXTOS: dict[str, dict[str, str]] = {
    ...
    "bp.opp_4": {"es": "*4.* Si necesitas ayuda con algún tema o has tenido alguna dificultad que quieras comentar", "en": "*4.* If you need help with anything or have had any difficulty you'd like to raise"},
