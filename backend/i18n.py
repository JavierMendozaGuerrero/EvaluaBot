...
TEXTOS: dict[str, dict[str, str]] = {
    ...
    "bm.ask_area_q": {"es": "¿A qué área perteneces?", "en": "Which area do you belong to?"},
    ...
    "bp.btn_urgency": {"es": "🚨 Urgencia", "en": "🚨 Urgent"},
    ...
    "bp.urgency_summary": {"es": "📋 Tu descripción de urgencia:\n_{desc}_\n\n¿La envío a tu CA?", "en": "📋 Your urgent description:\n_{desc}_\n\nShall I send it to your CA?"},
    "bp.btn_send_ca": {"es": "✅ Enviar al CA", "en": "✅ Send to CA"},
    "bp.eval_finished": {"es": "Evaluación finalizada, por favor salga del hilo. 👋", "en": "Evaluation finished, please leave the thread. 👋"},
    "bp.describe_urgency": {"es": "🚨 Describe en una frase breve la urgencia:", "en": "🚨 Describe the urgent matter in one short sentence:"},
    "bp.describe_urgency_again": {"es": "🚨 Describe de nuevo la urgencia:", "en": "🚨 Describe the urgent matter again:"},
    ...
    "bp.urgency_sent": {"es": "✅ Tu urgencia ha sido enviada a tu CA.", "en": "✅ Your urgent message has been sent to your CA."},
    "bp.urgency_not_sent": {"es": "⚠️ No se pudo notificar a tu CA. Contacta directamente.", "en": "⚠️ Could not notify your CA. Contact them directly."},
    ...
    "bp.urgency_sent_update": {"es": "🚨 Urgencia enviada al CA ✅", "en": "🚨 Urgent message sent to CA ✅"},
